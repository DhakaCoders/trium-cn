 ...
 */
class WC_Widget_CBV_Price_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'CBV Filter Products by Price', 'woocommerce' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
...
function cbv_wc_price_slider_load_widget() {
    register_widget( 'WC_Widget_CBV_Price_Filter' );
}
add_action( 'widgets_init', 'cbv_wc_price_slider_load_widget' );